 ...
 *
 * @author xu.liang
 * @since 2022/12/22 11:07
 */
public class NumOfArraysTest {
    ...
    public static void main(String[] args) {
        int[] a = new int[]{1, 2 ,1, 2, 3, 4, 5};
        int[] numsAppearOnce = findNumsAppearOnce(a);
        System.out.println("numsAppearOnce = " + Arrays.toString(numsAppearOnce));

        int[] aa = new int[]{1, 2 ,1, 1, 2, 2, 5};
        int numberAppearingOnce = findNumberAppearingOnce(aa);
        System.out.println("numberAppearingOnce = " + numberAppearingOnce);
    }
